...
#TODO Create separate functions for the size, pepperoni, and cheese
#TODO Understand why we use the global keyword to change variables initialized outside of the function
#TODO Inside the functions create a match case for the inputs and use a ternary operator for the
# pepperoni
